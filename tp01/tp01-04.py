...
# FUNCIONES
#----------------------------------------------------------------------------------------------
def calcular_vuelto(compra, pagoDelCliente):
    vuelto = pagoDelCliente - compra
...
pagoDelCliente = int(input("Ingrese el dinero recibido: "))

calcular_vuelto(compra, pagoDelCliente)